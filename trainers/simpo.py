...
def main(args):
    ...
    config = DPOConfig(
        ...
        ipo_loss=False,  # SimPO doesn't use IPO loss
        project_kwargs={
    ...
    # Set gamma for SimPO (add to config as attribute)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--temperature', type=float, default=1.0, help='the temperature (beta) for SimPO')
    parser.add_argument('--gamma', type=float, default=0.0, help='the gamma parameter for SimPO loss')
